...
from functions import downloadVideo, setVideoResolution
# STEP 1: Download the minecraft parkour video
newlink = "https://www.youtube.com/watch?v=952ILTHDgC4"
resolution = downloadVideo(newlink, "bottom.mp4")

# STEP 2: Do the resolution calculations (used later for cropping)
if resolution < 720:
    raise Exception("Resolution for video is too low, try another video")
else:
    width, height = setVideoResolution(resolution)
